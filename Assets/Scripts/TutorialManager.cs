...
public class TutorialManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (OVRInput.GetDown(OVRInput.Button.Two))
        {
            ...
            switch (TutorialStage)
            {
                ...
                case 1:
                    ...
                    TutorialCanvas.GetComponent<RectTransform>().anchoredPosition3D = new Vector3(0.5f, -0.35f, 2.5f);
                ...
                case 3:
                    ...
                    TutorialCanvas.GetComponent<RectTransform>().anchoredPosition3D = new Vector3(0f, -0.2f, 2.5f);
        ...
        if (SearchLogic.showRays && TutorialStage >= 4)
        {
            ...
            ContinueText.text = "";
            TutorialCanvas.GetComponent<RectTransform>().anchoredPosition3D = new Vector3(-0.45f, 0.35f, 2.5f);
